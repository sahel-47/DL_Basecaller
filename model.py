...
from nn import  Convolution, LinearCRFEncoder, Serial, Permute, layers, to_dict, from_dict, register
...
class Model(SeqdistModel):
    ...
    def __init__(self, config):
        ...
        encoder_dict = model_dict.pop("encoder")
        seqdist_dict = model_dict.pop("seqdist")        

        seqdist = CTC_CRF(**seqdist_dict)
        encoder = from_dict(encoder_dict)

        super().__init__(encoder, seqdist, **model_dict) 
        self.config = config 